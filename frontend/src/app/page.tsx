      ...
      <div className="max-w-6xl mx-auto space-y-16 py-4">
        ...
        <section className="relative text-center py-12 space-y-6 overflow-hidden">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-950/50 border border-purple-800/50 text-purple-300 text-xs font-mono mb-2"
          >
            <Sparkles className="w-3.5 h-3.5 text-purple-400 animate-pulse" />
            <span>Introducing Mcode-Agent 2.0 • Live Interactive Code Tutor</span>
          </motion.div>
          ...
          >
            ...
            <Link
              href="/workspace"
              className="px-6 py-3.5 rounded-xl bg-slate-900 border border-slate-800 font-semibold text-sm text-slate-200 hover:text-white hover:border-purple-500/50 hover:bg-slate-800/60 transition-all flex items-center gap-2"
            >
        ...
        >
          <div className="flex items-center justify-between border-b border-slate-800/80 pb-4 mb-6">
            <div className="flex items-center gap-2">
              ...
              <span className="ml-3 text-xs font-mono text-slate-400">mcode-agent-live-workspace // App.tsx</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Editor Code Preview */}
            <div className="bg-[#090a10] p-4 rounded-xl border border-slate-800 font-mono text-xs text-slate-300 space-y-2">
              ...
              <p className="text-slate-500"><span className="text-pink-400">import</span> React, &#123; useActionState &#125; <span className="text-pink-400">from</span> <span className="text-emerald-400">&apos;react&apos;</span>;</p>
              <p className="text-slate-500"><span className="text-purple-400">export default function</span> <span className="text-blue-400">InteractiveCounter</span>() &#123;</p>
              <p className="pl-4 text-emerald-300 bg-emerald-950/30 py-1 border-l-2 border-emerald-400">
                + <span className="text-slate-400">// Student added manual state handler</span>
              </p>
              <p className="pl-4 text-slate-300">const [state, formAction, isPending] = useActionState(updateScore, 0);</p>
              <p className="pl-4 text-slate-300"><span className="text-purple-400">return</span> (</p>
              <p className="pl-8 text-blue-300">&lt;<span className="text-pink-400">button</span> action=&#123;formAction&#125; disabled=&#123;isPending&#125;&gt;</p>
              <p className="pl-12 text-slate-200">Increment Score</p>
              <p className="pl-8 text-blue-300">&lt;/<span className="text-pink-400">button</span>&gt;</p>
            ...
            <div className="glass-panel p-5 rounded-xl flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <div className="bg-purple-950/30 p-3 rounded-lg border border-purple-900/40 text-xs text-purple-200 leading-relaxed">
                  <p className="font-semibold text-purple-300 mb-1">💡 Live Feedback on your edit:</p>
                  &quot;Great job adding <code className="text-pink-300 font-mono">useActionState</code>! Notice how <code className="text-pink-300 font-mono">isPending</code> automatically handles loading UI without explicit <code className="text-pink-300 font-mono">useState</code> setters. Shall we run the live test server?&quot;
                </div>
              </div>
        ...
        <section className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <h3 className="text-base font-bold text-white">2-Way Live Discussion</h3>
            ...
            >
              ...
              <h3 className="text-base font-bold text-white">Live VS Code Control</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-pink-950/60 border border-pink-800/40 flex items-center justify-center text-pink-400">
                <Zap className="w-5 h-5" />
              </div>
              <h3 className="text-base font-bold text-white">Student Edit Detector</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            >
              ...
              <h3 className="text-base font-bold text-white">Desktop Folder Sync</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <section className="space-y-8">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-white">Featured Practical Courses</h2>
              <p className="text-slate-400 text-xs mt-1">Enroll and sync directly to your desktop workspace.</p>
            </div>
            <Link
              href="/learning-space"
              className="text-xs text-purple-400 hover:text-purple-300 font-mono font-semibold flex items-center gap-1"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glass-card p-6 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="px-2.5 py-1 rounded-full bg-blue-950/60 border border-blue-800/40 text-blue-300 text-[10px] font-mono font-semibold">
                    REACT 19
                  </span>
                  <span className="text-xs text-slate-400 font-mono">24 Lessons • Live Workspace</span>
                </div>
                <h3 className="text-lg font-bold text-white">React 19 & Server Components Live Mastery</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <Link
                href="/learning-space"
                className="w-full py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-center text-xs font-semibold text-slate-200 hover:text-white transition-all"
              >
            ...
            <div className="glass-card p-6 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="px-2.5 py-1 rounded-full bg-purple-950/60 border border-purple-800/40 text-purple-300 text-[10px] font-mono font-semibold">
                    PYTHON AI AGENTS
                  </span>
                  <span className="text-xs text-slate-400 font-mono">28 Lessons • Live Workspace</span>
                </div>
                <h3 className="text-lg font-bold text-white">Python AI Agents & Autonomous Workflows</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
